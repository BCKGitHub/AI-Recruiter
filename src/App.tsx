...
import { PlusCircleIcon, ListIcon, BriefcaseIcon, BookOpenIcon } from "lucide-react";

type Page = "setup" | "interviews" | "transcript" | "docs";
...
export default function App() {
  ...
  const navItems: { id: Page; label: string; icon: React.ReactNode }[] = [
    ...
    { id: "docs", label: "Documentation", icon: <BookOpenIcon size={16} /> },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className={page === "docs" ? "px-8 py-6" : "px-8 py-8"}>
          {page === "setup" && (
